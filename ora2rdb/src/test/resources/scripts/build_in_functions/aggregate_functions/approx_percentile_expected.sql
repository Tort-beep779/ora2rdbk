SELECT department_id "Department",
       [-unconvertible APPROX_PERCENTILE(0.25 DETERMINISTIC)
         WITHIN GROUP (ORDER BY salary ASC)] "25th Percentile Salary",
       [-unconvertible APPROX_PERCENTILE(0.50 DETERMINISTIC)
         WITHIN GROUP (ORDER BY salary ASC)] "50th Percentile Salary",
       [-unconvertible APPROX_PERCENTILE(0.75 DETERMINISTIC)
