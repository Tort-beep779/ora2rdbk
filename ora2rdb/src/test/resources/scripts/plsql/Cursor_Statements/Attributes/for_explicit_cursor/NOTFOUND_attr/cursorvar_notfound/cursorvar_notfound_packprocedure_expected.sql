CREATE PACKAGE PackP_Cursorvar_Notfound
SQL SECURITY DEFINER
AS BEGIN
    PROCEDURE PP_Cursorvar_Notfound;
END;

CREATE PACKAGE BODY PackP_Cursorvar_Notfound
AS BEGIN
   PROCEDURE PP_Cursorvar_Notfound
   AS
    /*
    ...
    */
    ...
    /*
       ...
       IF [-unconvertible c1]%NOTFOUND THEN res := res + 1;
       END IF;
       IF [-unconvertible c2]%NOTFOUND THEN res := res + 10;
       END IF;
