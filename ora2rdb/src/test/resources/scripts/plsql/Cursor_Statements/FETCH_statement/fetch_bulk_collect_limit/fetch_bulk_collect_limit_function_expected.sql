CREATE GLOBAL TEMPORARY TABLE sals_F_Fetch_Bulk_Collect_Limit (
    K INTEGER,
    VAL NUMERIC(10,2),
...
BEGIN
  DELETE FROM sals_F_Fetch_Bulk_Collect_Limit WHERE K <> 0;  
  OPEN c1;
  ...
  BEGIN
    INSERT INTO sals_F_Fetch_Bulk_Collect_Limit(K, VAL) VALUES (seq_fetch, sals_var);
