CREATE GLOBAL TEMPORARY TABLE sals_PF_Fetch_Bulk_Collect_Limit (
    K INTEGER,
    VAL NUMERIC(10,2),
...
AS BEGIN
   ...
   BEGIN
     DELETE FROM sals_PF_Fetch_Bulk_Collect_Limit WHERE K <> 0;  
     OPEN c1;
     ...
     BEGIN
       INSERT INTO sals_PF_Fetch_Bulk_Collect_Limit(K, VAL) VALUES (seq_fetch, sals_var);
