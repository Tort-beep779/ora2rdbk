...
BEGIN
   ...
   FOR SELECT ID FROM VEC_F_For_With_While_and_When
   ORDER BY ID ASC
   INTO :i_FOR1
   DO
   BEGIN
...
AS BEGIN
   ...
   BEGIN
     ...
     FOR SELECT ID FROM VEC_Pack_For_With_While_and_When_PF_For_With_While_and_When
     ORDER BY ID ASC
     INTO :i_FOR1
     DO
     BEGIN
   ...
   BEGIN
     ...
     FOR SELECT ID FROM VEC_Pack_For_With_While_and_When_PP_For_With_While_and_When
     ORDER BY ID ASC
     INTO :i_FOR1
     DO
     BEGIN
