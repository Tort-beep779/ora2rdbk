...
BEGIN
  ...
  FOR SELECT K FROM VEC_P_From_Reverse_Assoc_Array
  ORDER BY K DESC
  INTO :i_FOR1
  DO
  BEGIN
...
BEGIN
  ...
  FOR SELECT K FROM VEC_F_From_Reverse_Assoc_Array
  ORDER BY K DESC
  INTO :i_FOR1
  DO
  BEGIN
...
AS BEGIN
   ...
   BEGIN
     ...
     FOR SELECT K FROM VEC_Pack_From_Reverse_Assoc_Array_PF_From_Reverse_Assoc_Array
     ORDER BY K DESC
     INTO :i_FOR1
     DO
     BEGIN
   ...
   BEGIN
     ...
     FOR SELECT K FROM VEC_Pack_From_Reverse_Assoc_Array_PP_From_Reverse_Assoc_Array
     ORDER BY K DESC
     INTO :i_FOR1
     DO
     BEGIN
...
BEGIN
  ...
  FOR SELECT K FROM VEC_T_From_Reverse_Assoc_Array
  ORDER BY K DESC
  INTO :i_FOR1
  DO
  BEGIN
