...
BEGIN
  ...
  FOR SELECT ID FROM VEC_P_Same_Name_Var
  ORDER BY ID ASC
  INTO :i_FOR1
  DO
  BEGIN
...
BEGIN
  ...
  FOR SELECT ID FROM VEC_F_Same_Name_Var
  ORDER BY ID ASC
  INTO :i_FOR1
  DO
  BEGIN
...
AS BEGIN
   ...
   BEGIN
    ...
    FOR SELECT ID FROM VEC_Pack_Same_Name_Var_PF_Same_Name_Var
    ORDER BY ID ASC
    INTO :i_FOR1
    DO
    BEGIN
   ...
   BEGIN
     ...
     FOR SELECT ID FROM VEC_Pack_Same_Name_Var_PP_Same_Name_Var
     ORDER BY ID ASC
     INTO :i_FOR1
     DO
     BEGIN
...
BEGIN
  ...
  FOR SELECT ID FROM VEC_T_Same_Name_Var
  ORDER BY ID ASC
  INTO :i_FOR1
  DO
  BEGIN
