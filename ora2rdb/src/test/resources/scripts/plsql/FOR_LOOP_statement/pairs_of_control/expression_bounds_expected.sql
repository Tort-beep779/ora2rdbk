...
BEGIN
   ...
   FOR SELECT ID, VAL FROM NT1_MULTUNION_NT2_F_Expr_Bounds
   ORDER BY ID ASC
   INTO :i_FOR1, :j_FOR1
   DO
   BEGIN
...
AS BEGIN
   ...
   BEGIN
     ...
     FOR SELECT ID, VAL FROM NT1_MULTUNION_NT2_Pack_Expr_Bounds_PF_Expr_Bounds
     ORDER BY ID ASC
     INTO :i_FOR1, :j_FOR1
     DO
     BEGIN
   ...
   BEGIN
     ...
     FOR SELECT ID, VAL FROM NT1_MULTUNION_NT2_Pack_Expr_Bounds_PP_Expr_Bounds
     ORDER BY ID ASC
     INTO :i_FOR1, :j_FOR1
     DO
     BEGIN
...
BEGIN
   ...
   FOR SELECT ID, VAL FROM NT1_MULTUNION_NT2_T_Expr_Bounds
   ORDER BY ID ASC
   INTO :i_FOR1, :j_FOR1
   DO
   BEGIN
...
BEGIN
   ...
   FOR SELECT ID, VAL FROM NT1_MULTUNION_NT2_NestTable_1
   ORDER BY ID ASC
   INTO :i_FOR1, :j_FOR1
   DO
   BEGIN
