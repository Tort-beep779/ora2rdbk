...
BEGIN
  ...
  FOR SELECT K, VAL FROM VEC1_P_Few_Fors
  ORDER BY K ASC
  INTO :i_FOR1, :j_FOR1
  DO
  BEGIN
  END
  FOR SELECT ID, VAL FROM VEC2_P_Few_Fors
  ORDER BY ID ASC
  INTO :i_FOR2, :j_FOR2
  DO
  BEGIN
...
AS BEGIN
   ...
   BEGIN
     ...
     FOR SELECT K, VAL FROM VEC1_Pack_Few_Fors_PF_Few_Fors
     ORDER BY K ASC
     INTO :i_FOR1, :j_FOR1
     DO
     BEGIN
     END
     FOR SELECT ID, VAL FROM VEC2_Pack_Few_Fors_PF_Few_Fors
     ORDER BY ID ASC
     INTO :i_FOR2, :j_FOR2
     DO
     BEGIN
   ...
   BEGIN
     ...
     FOR SELECT K, VAL FROM VEC1_Pack_Few_Fors_PP_Few_Fors
     ORDER BY K ASC
     INTO :i_FOR1, :j_FOR1
     DO
     BEGIN
     END
     FOR SELECT ID, VAL FROM VEC2_Pack_Few_Fors_PP_Few_Fors
     ORDER BY ID ASC
     INTO :i_FOR2, :j_FOR2
     DO
     BEGIN
...
BEGIN
  ...
  FOR SELECT K, VAL FROM VEC1_T_Few_Fors
  ORDER BY K ASC
  INTO :i_FOR1, :j_FOR1
  DO
  BEGIN
  END
  FOR SELECT ID, VAL FROM VEC2_T_Few_Fors
  ORDER BY ID ASC
  INTO :i_FOR2, :j_FOR2
  DO
  BEGIN
