...
BEGIN
  ...
  FOR SELECT K, VAL FROM VEC_F_For_With_Immut_Index
  ORDER BY K ASC
  INTO :i_FOR1, :j_FOR1
  DO
  BEGIN
...
AS BEGIN
   ...
   BEGIN
     ...
     FOR SELECT K, VAL FROM VEC_Pack_For_With_Immut_Index_PF_For_With_Immut_Index
     ORDER BY K ASC
     INTO :i_FOR1, :j_FOR1
     DO
     BEGIN
   ...
   BEGIN
     ...
     FOR SELECT K, VAL FROM VEC_Pack_For_With_Immut_Index_PP_For_With_Immut_Index
     ORDER BY K ASC
     INTO :i_FOR1, :j_FOR1
     DO
     BEGIN
...
BEGIN
  ...
  FOR SELECT K, VAL FROM VEC_T_For_With_Immut_Index
  ORDER BY K ASC
  INTO :i_FOR1, :j_FOR1
  DO
  BEGIN
