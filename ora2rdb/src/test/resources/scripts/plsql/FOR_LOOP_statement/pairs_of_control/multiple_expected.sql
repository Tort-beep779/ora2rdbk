...
BEGIN
  ...
  FOR SELECT ID, VAL FROM VEC1_P_multiple
  ORDER BY ID ASC
  INTO :i_FOR1, :j_FOR1
  DO
  BEGIN
    summa = :summa + i_FOR1; 
  END
  FOR SELECT ID, VAL FROM VEC2_P_multiple
  ORDER BY ID ASC
  INTO :i_FOR1, :j_FOR1
  DO
  BEGIN
...
AS BEGIN
  ...
  BEGIN
     ...
     FOR SELECT ID, VAL FROM VEC1_Pack_multiple_PF_multiple
     ORDER BY ID ASC
     INTO :i_FOR1, :j_FOR1
     DO
     BEGIN
       summa = :summa + i_FOR1; 
     END
     FOR SELECT ID, VAL FROM VEC2_Pack_multiple_PF_multiple
     ORDER BY ID ASC
     INTO :i_FOR1, :j_FOR1
     DO
     BEGIN
  ...
  BEGIN
     ...
     FOR SELECT ID, VAL FROM VEC1_Pack_multiple_PP_multiple
     ORDER BY ID ASC
     INTO :i_FOR1, :j_FOR1
     DO
     BEGIN
       summa = :summa + i_FOR1; 
     END
     FOR SELECT ID, VAL FROM VEC2_Pack_multiple_PP_multiple
     ORDER BY ID ASC
     INTO :i_FOR1, :j_FOR1
     DO
     BEGIN
...
BEGIN
  ...
  FOR SELECT ID, VAL FROM VEC1_T_multiple
  ORDER BY ID ASC
  INTO :i_FOR1, :j_FOR1
  DO
  BEGIN
    summa = :summa + i_FOR1; 
  END
  FOR SELECT ID, VAL FROM VEC2_T_multiple
  ORDER BY ID ASC
  INTO :i_FOR1, :j_FOR1
  DO
  BEGIN
...
BEGIN
  ...
  FOR SELECT ID, VAL FROM VEC1_Varray_1
  ORDER BY ID ASC
  INTO :i_FOR1, :j_FOR1
  DO
  BEGIN
    summa = :summa + i_FOR1; 
  END
  FOR SELECT ID, VAL FROM VEC2_NestTable_1
  ORDER BY ID ASC
  INTO :i_FOR1, :j_FOR1
  DO
  BEGIN
