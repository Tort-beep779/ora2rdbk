...
BEGIN
  ...
  FOR SELECT VAL FROM VEC1_P_Few_Fors
  ORDER BY K ASC
  INTO :i_FOR1
  DO
  BEGIN
  END
  FOR SELECT VAL FROM VEC2_P_Few_Fors
  ORDER BY ID ASC
  INTO :i_FOR2
  DO
  BEGIN
...
BEGIN
  ...
  FOR SELECT VAL FROM VEC1_F_Few_Fors
  ORDER BY K ASC
  INTO :i_FOR1
  DO
  BEGIN
  END
  FOR SELECT VAL FROM VEC2_F_Few_Fors
  ORDER BY ID ASC
  INTO :i_FOR2
  DO
  BEGIN
...
BEGIN
  ...
  FOR SELECT VAL FROM VEC1_T_Few_Fors
  ORDER BY K ASC
  INTO :i_FOR1
  DO
  BEGIN
  END
  FOR SELECT VAL FROM VEC2_T_Few_Fors
  ORDER BY ID ASC
  INTO :i_FOR2
  DO
  BEGIN
