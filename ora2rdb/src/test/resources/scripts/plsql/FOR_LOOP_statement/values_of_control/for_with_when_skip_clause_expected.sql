...
BEGIN
   ...
   FOR SELECT VAL FROM VEC_P_For_With_When
   ORDER BY ID ASC
   INTO :i_FOR1
   DO
   BEGIN
...
AS BEGIN
   ...
   BEGIN
     ...
     FOR SELECT VAL FROM VEC_Pack_For_With_When_PF_For_With_When
     ORDER BY ID ASC
     INTO :i_FOR1
     DO
     BEGIN
   ...
   BEGIN
     ...
     FOR SELECT VAL FROM VEC_Pack_For_With_When_PP_For_With_When
     ORDER BY ID ASC
     INTO :i_FOR1
     DO
     BEGIN
