...
BEGIN
  ...
  FOR SELECT VAL FROM VEC_F_For_With_While
  ORDER BY K ASC
  INTO :i_FOR1
  DO
  BEGIN
...
AS BEGIN
   ...
   BEGIN
     ...
     FOR SELECT VAL FROM VEC_Pack_For_With_While_PF_For_With_While
     ORDER BY K ASC
     INTO :i_FOR1
     DO
     BEGIN
   ...
   BEGIN
     ...
     FOR SELECT VAL FROM VEC_Pack_For_With_While_PP_For_With_While
     ORDER BY K ASC
     INTO :i_FOR1
     DO
     BEGIN
...
BEGIN
  ...
  FOR SELECT VAL FROM VEC_T_For_With_While
  ORDER BY K ASC
  INTO :i_FOR1
  DO
  BEGIN
