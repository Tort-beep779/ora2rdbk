...
/* Пакет */
CREATE OR REPLACE PACKAGE Pack_From_Reverse_Assoc_Array
AS 
...
/* Тело пакета */
CREATE OR REPLACE PACKAGE BODY Pack_From_Reverse_Assoc_Array
AS 
   FUNCTION PF_From_Reverse_Assoc_Array
   RETURN PLS_INTEGER
   IS
...
/* Триггер DML */
CREATE OR REPLACE TRIGGER T_From_Reverse_Assoc_Array
  AFTER INSERT 
  ON students
  FOR EACH ROW
DECLARE
