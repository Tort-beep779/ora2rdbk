...
BEGIN
   ...
   FOR SELECT VAL FROM VEC_F_From_Varray
   ORDER BY ID ASC
   INTO :i_FOR1
   DO
   BEGIN
...
AS BEGIN
   ...
   BEGIN
     ...
     FOR SELECT VAL FROM VEC_Pack_From_Varray_PF_From_Varray
     ORDER BY ID ASC
     INTO :i_FOR1
     DO
     BEGIN
   ...
   BEGIN
     ...
     FOR SELECT VAL FROM VEC_Pack_From_Varray_PP_From_Varray
     ORDER BY ID ASC
     INTO :i_FOR1
     DO
     BEGIN
...
BEGIN
   ...
   FOR SELECT VAL FROM VEC_T_From_Varray
   ORDER BY ID ASC
   INTO :i_FOR1
   DO
   BEGIN
