/* Процедура */
CREATE GLOBAL TEMPORARY TABLE VEC_P_Index_With_Label (
...
BEGIN
   INSERT INTO VEC_P_Index_With_Label(VAL) VALUES ('John');
   INSERT INTO VEC_P_Index_With_Label(VAL) VALUES ('Mary');
   INSERT INTO VEC_P_Index_With_Label(VAL) VALUES ('Alberto');
   INSERT INTO VEC_P_Index_With_Label(VAL) VALUES ('Juanita');
   forlabel:
   FOR SELECT VAL FROM VEC_P_Index_With_Label
   ORDER BY ID ASC
   INTO :i_FOR1
   DO
   BEGIN
...
BEGIN
   ...
   forlabel:
   FOR SELECT VAL FROM VEC_F_Index_With_Label
   ORDER BY ID ASC
   INTO :i_FOR1
   DO
   BEGIN
...
AS BEGIN
   ...
   BEGIN
     ...
     forlabel:
     FOR SELECT VAL FROM VEC_Pack_Index_With_Label_PF_Index_With_Label
     ORDER BY ID ASC
     INTO :i_FOR1
     DO
     BEGIN
   ...
   BEGIN
     ...
     forlabel:
     FOR SELECT VAL FROM VEC_Pack_Index_With_Label_PP_Index_With_Label
     ORDER BY ID ASC
     INTO :i_FOR1
     DO
     BEGIN
...
/* Триггер DML */
CREATE GLOBAL TEMPORARY TABLE VEC_T_Index_With_Label (
    ID  BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    VAL VARCHAR(15)
);
...
AS
   ...
   DECLARE i_FOR1 VARCHAR(15);
BEGIN
   INSERT INTO VEC_T_Index_With_Label(VAL) VALUES ('John');
   INSERT INTO VEC_T_Index_With_Label(VAL) VALUES ('Mary');
   INSERT INTO VEC_T_Index_With_Label(VAL) VALUES ('Alberto');
   INSERT INTO VEC_T_Index_With_Label(VAL) VALUES ('Juanita');
   forlabel:
   FOR SELECT VAL FROM VEC_T_Index_With_Label
   ORDER BY ID ASC
   INTO :i_FOR1
   DO
   BEGIN
