...
BEGIN
  ...
  FOR SELECT VAL FROM VEC1_P_multiple
  ORDER BY ID ASC
  INTO :i_FOR1
  DO
  BEGIN
    summa = :summa || i_FOR1; 
  END
  FOR SELECT VAL FROM VEC2_P_multiple
  ORDER BY ID ASC
  INTO :i_FOR1
  DO
  BEGIN
...
BEGIN
  ...
  FOR SELECT VAL FROM VEC1_F_multiple
  ORDER BY ID ASC
  INTO :i_FOR1
  DO
  BEGIN
    summa = :summa || i_FOR1; 
  END
  FOR SELECT VAL FROM VEC2_F_multiple
  ORDER BY ID ASC
  INTO :i_FOR1
  DO
  BEGIN
...
BEGIN
  ...
  FOR SELECT VAL FROM VEC1_T_multiple
  ORDER BY ID ASC
  INTO :i_FOR1
  DO
  BEGIN
    summa = :summa || i_FOR1; 
  END
  FOR SELECT VAL FROM VEC2_T_multiple
  ORDER BY ID ASC
  INTO :i_FOR1
  DO
  BEGIN
