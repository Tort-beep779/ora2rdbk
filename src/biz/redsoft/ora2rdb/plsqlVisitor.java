...
public interface plsqlVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link plsqlParser#compute_statistics_clause}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCompute_statistics_clause(plsqlParser.Compute_statistics_clauseContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link plsqlParser#is_condition}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIs_condition(plsqlParser.Is_conditionContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link plsqlParser#comment}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitComment(plsqlParser.CommentContext ctx);
	/**
